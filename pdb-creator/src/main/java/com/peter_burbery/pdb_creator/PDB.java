/**
 * @since 2024-W42-7 14.09.41.232 -0400
 * @author peter
 */
...
public class PDB {
	...
	public static Connection getConnection(String serviceName, boolean isSysDBA) throws SQLException {
	...
	public static boolean checkIfPDBExists(Connection conn, String pdbName) throws SQLException {
	...
	public static boolean checkForActiveConnections(Connection conn, String pdbName) throws SQLException {
	...
	public static void dropPDB(Connection conn, String pdbName) throws SQLException {
	...
	public static void createPDB(Connection conn, String pdbName, String adminName, String adminPassword,
	...
	public static void grantRolesAndPrivileges(Connection conn, String pdbName, String username) throws SQLException {
		try (Statement stmt = conn.createStatement()) {
